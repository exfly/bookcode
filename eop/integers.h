...
template <typename I>
requires(Integer(I)) bool positive(const I &a)
{
    return I(0) < a;
}

template <typename I>
requires(Integer(I)) bool negative(const I &a)
{
    return a < I(0);
}

template <typename I>
requires(Integer(I)) bool zero(const I &a)
{
    return a == I(0);
}

template <typename I>
requires(Integer(I)) bool one(const I &a)
{
    return a == I(1);
}

template <typename I>
requires(Integer(I)) bool even(const I &a)
{
    return (a bitand I(1)) == I(0);
}

template <typename I>
requires(Integer(I)) bool odd(const I &a)
{
    return (a bitand I(1)) != I(0);
}
